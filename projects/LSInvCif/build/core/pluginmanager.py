...
class PluginManager(object):
    """
    A class for managing examplePlugins, cmd line options,
    ...
    def __init__(self,
        ...
        headlines: A boolean. If False, called examplePlugins do not print
                  an extra headline.
        alpha:   A function. The function must accept at least one
                  ...
                  preprocessing that is required before any examplePlugins
        ...
        self.moduledepth = 0
        self.path = self.config.get('Main', 'PluginPath')
    ...
    def get_frequency_cutoff(self):
        ...
        """
        return self.config.get('Database','Frequency_cutoff')
    ...
    def parse_argv(self, argv):
        ...
        , as specified in the examplePlugins global 'OPTIONS_ARGUMENTS'
    ...
    def scan_for_plugins(self):
        """
        Scans the programs plugin directory for examplePlugins.
        ...
        in the .examplePlugins attribute.
        """
        self.printer('Scanning for examplePlugins in {}.'.format(self.path))
